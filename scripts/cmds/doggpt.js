  ...
  onStart: async function ({ api, event, args, usersData }) {
    try {
      ...
      if (query) {
        ...
        const apiUrl = `https://lianeapi.onrender.com/@nealianacagara/api/dogbot_by_pawsome?key=j86bwkwo-8hako-12C&userName=${encodeURIComponent(name || "a user")}&query=${encodeURIComponent(query)}`;
