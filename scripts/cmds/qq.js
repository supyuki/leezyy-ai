  ...
  onStart: async function ({ api, event, args, usersData }) {
    try {
      ...
      if (query) {
        ...
        const apiUrl = `https://lianeapi.onrender.com/@JenicaDev/api/quantum_quill?key=j86bwkwo-8hako-12C&userName=${encodeURIComponent(name || "a user")}&query=${encodeURIComponent(query)}`;
